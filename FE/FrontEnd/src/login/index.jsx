        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input id="remember-me" name="rememberMe" type="checkbox" className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" checked={formData.rememberMe} onChange={handleChange} />
              <label htmlFor="remember-me" className="ml-2 text-sm text-gray-900">Remember me</label>
            </div>
            <div className="text-sm">
              <a href="#" className="font-medium text-rose-500 hover:text-pink">Forgot password?</a>
            </div>
          </div>
          ...
          <p className="mt-4 text-center text-sm text-gray-600">
            Don't have an account? <a href="/register" className="font-medium text-rose-500 hover:text-rose-500">Register here</a>
          </p>
          ...
          <div className="relative mt-4">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-rose-55 text-gray-500">Or continue with</span>
            </div>
          </div>
